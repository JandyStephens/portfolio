// Credit to Huw Llewellyn at https://codepen.io/nosurprisethere/pen/yoEmQE
...
class Application {
  ...
  render() {
    ...
    let gradient = this.context.createRadialGradient(
      this.universe.light.position.x,
      this.universe.light.position.y,
      0.9 * settings.spotlightRadius,
      this.universe.light.position.x,
      this.universe.light.position.y,
      0
    );
    ...
    gradient = this.contextOverlay.createRadialGradient(
      this.universe.light.position.x,
      this.universe.light.position.y,
      settings.spotlightRadius,
      this.universe.light.position.x,
      this.universe.light.position.y,
      0
    );
...
class Universe {
  constructor(width, height) {
    ...
    this.light = new Light(width * 0.75, height * 0.35);
  }
...
class Box {
  ...
  getCornerLocations() {
    ...
    for (var i = 0; i < this.sides; i++) {
      ...
      let x =
        this.position.x +
        this.radius * Math.sin(this.rotation + i * internalAngle);
      let y =
        this.position.y +
        this.radius * Math.cos(this.rotation + i * internalAngle);
